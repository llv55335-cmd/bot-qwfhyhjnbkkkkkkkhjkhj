...
ALL_TOOLS = [TIME_TOOL, SCHEDULE_TOOL, LUTOPIA_TOOL, MEMORY_MANAGEMENT_TOOL, TRAVEL_SYSTEM_TOOL, CODE_ANALYSIS_TOOL, API_EXPLORE_TOOL]
...
async def _execute_tool(tc: dict, chat_id: str) -> str:
    ...
    if name == "get_current_time":
        ...
        from tools.xiaowo_client import travel_control
        return await travel_control(args)
    
    elif name == "code_analysis":
        from tools.xiaowo_client import code_analysis
        return await code_analysis(args)
